...
class Test(TestCase):
    ...
    def test_collect_similar_names_key(self):
        keys = seperator.collect_similar_names('foo.txt')
        expected =  ['Gracie-Gracie_001.jpg\n' ,'Gracie-Gracie_002.jpg\n' ,
                                             ...
                                             'Gracie-Gracie_044.jpg\n' ,'Gracie-Gracie_045.jpg\n' ,
        ...
        returned = keys.get('Gracie-Gracie')
        self.assertEqual(expected, returned)

    def test_collect_similar_names_not_found(self):
        keys = seperator.collect_similar_names('foo.txt')
        self.assertEqual(keys.get('foo.txt'), None)
            
    def test_collect_similar_names_folder(self):
        keys = seperator.collect_similar_names("/Volumes/One Touch/2022-04-12/Earmiller/femjoy_Aida")
        self.assertNotEqual(keys.get('femjoy_Ellen - Bedtime Story'), (
